...
![Tilburg University Coding Cafe](images/tiu-cafe.jpg){.lightbox fig-alt="A picture showing a row of six open pizza boxes on a table in the back, with people working on their laptops in the row in front."}
